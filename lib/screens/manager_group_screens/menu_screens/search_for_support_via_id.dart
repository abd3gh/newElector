...
class SearchSupportViaID extends StatefulWidget {
  const SearchSupportViaID({Key? key}) : super(key: key);

  @override
  State<SearchSupportViaID> createState() => _SearchSupportViaIDState();
}

class _SearchSupportViaIDState extends State<SearchSupportViaID> {
            ...
            WidgetButton(
              onPress: () async {
                ...
                await ApiControllers()
                    .searchfollower(_idTextEditingController.text.trim()).then((value) => {
